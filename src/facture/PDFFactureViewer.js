    ...
    <div style={{
      ...
      <div style={{        
       ...
       // padding: '20px', // Un peu d'espace autour du contenu PDF
        ...
        <FontAwesomeIcon icon={faPrint} onClick={handlePrint} style={{ cursor: 'pointer', color: 'black', fontSize: '24px', marginRight: '15px'}} />
        <FontAwesomeIcon icon={faTimes} onClick={() => setShowPDF(false)} style={{ cursor: 'pointer', color: 'black', fontSize: '24px' }}/>
      </div>
    </div>
  );
};
