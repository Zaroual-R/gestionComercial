...
const AddRole = () => {
    ...
    return (
        <div className="container ajouter-role"> {/* Changed class to match AjouterFournisseur */}
            <div className="row">
                <div className="col-12">
                    <div className="card">
                        <div className="card-header bg-info text-white"> {/* You may want to adjust the color to match your header */}
                            <h3>Nouveau Rôle</h3>
                        </div>
                            ...
                            <form onSubmit={handleSubmit}>
                                <div className="form-row">
                                    <div className="form-group col-md-6">
                                        <label htmlFor="roleName">Nom de rôle :</label>
                                        <input type="text" className="form-control" name="roleName" value={formData.roleName} onChange={handleChange} id="roleName" placeholder='veuillez saisir le  nom de rôle' required/>
                                    </div>
                                </div>
                                <div className="form-group">
                                    <label htmlFor="permissions">Permissions :</label>
                                </div>
                                <Select className='monSelect'  options={options} isMulti value={options.filter(option => formData.previlegeSet.includes(option.value))} onChange={handleSelectChange} required/>
                                <div className='mt-4'>
                                    <button type="submit" className="btn btn-primary"><i className='fas fa-plus-circle' />Ajouter</button>
                                    &nbsp;&nbsp;&nbsp;
