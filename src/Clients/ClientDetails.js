...
const statusLabels = {
  ...
  return (
<div className="container  list-client Myfont">
  <div className="card shadow-lg">
    <div className="card-header text-center cardHeader text-white">
    ...
    <div className='card-footer'>
      <h4 className="text-center bg-info text-white p-2">Historique des Commandes</h4>
    ...
    <div className='card-footer'>
      <h4 className="text-center bg-info text-white p-2">Produits les Plus Commandés</h4>
      <table className='custom-table'>
        <thead >
          <tr>
